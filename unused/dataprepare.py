...
#                       'Weakly_labeled_data_1.1M/camera_negative.csv',
#                       encoding='utf-8').read().strip().split('\n')
...
#                 if key in models:
#                     a = key + ',' + normalize(str(models[key])) + "\n"
#                     file.write(a)
#                     i += 1
#                 else:
#                     spell_key = spell.correction(key)
#                     if spell_key in models:
#                         a = key + "," + normalize(str(models[spell_key])) + "\n"
#                         file.write(a)
#                         i += 1
#                     else:
#                         a = key + "," + spell_key + "\n"
...
#
#
# def weakly_data_test(pp_data_weak=False):
#
#     lines_pos1 = open('data/'
#                       'Weakly_labeled_data_1.1M/camera_positive.csv',
#                       encoding='utf-8').read().strip().split('\n')
